/*
 * Extra tests for arc-rff-blood-v300.
 *
...
import { arc_rff_blood_v300 as handler } from '../index.js';
	...
	describe('I/O', function() {
		...
		describe('identify()', function() {
			...
			it('should reject wrong file version', function() {
				...
				// This version number should be handled by arc-rff-blood-v200 instead.
				assert.equal(result.reason, `Unsupported RFF version 2.0.`);
				assert.equal(result.valid, false);
			});
